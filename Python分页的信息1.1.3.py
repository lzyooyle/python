...
def getResouces(url):
    ...
    webSourceCode=urllib2.urlopen(url).read().decode("utf-8","ignore")
...
for i in range(2,10):
	num=i
	url="https://www.ittime.com.cn/news/zixun_%d.shtml"%(num)
	getResouces(url)
	#print "https://www.ittime.com.cn/news/zixun_",i,"shtml"
